...
generate_ac_dataset(num_samples_per_unit=3500, 
                    output_filepath=os.path.join(SCRIPT_DIR,"SyntheticStatic", "SyntheticTrainingDataset.csv"))

preprocess_ac_data_tiered_scaling(input_filepath=os.path.join(SCRIPT_DIR,"SyntheticStatic", "SyntheticTrainingDataset.csv"),
                                  output_filepath=os.path.join(SCRIPT_DIR,"SyntheticStatic", "ScaledSyntheticTrainingDataset.csv"))
...
BASELINE_SYNTH_PATH = os.environ.get("COEVO_BASELINE_SYNTH_PATH",
    os.path.join(SCRIPT_DIR,"SyntheticStatic", "ScaledSyntheticTrainingDataset.csv"))

REAL_VALID_PATH = os.environ.get("COEVO_REAL_VALID_PATH",
    os.path.join(os.path.dirname(SCRIPT_DIR), "RealData", "Dataset_Train_70.csv"))

OUTPUT_DIR = os.environ.get("COEVO_OUTPUT_DIR",
    os.path.join(SCRIPT_DIR, "CoevolutionResult"))

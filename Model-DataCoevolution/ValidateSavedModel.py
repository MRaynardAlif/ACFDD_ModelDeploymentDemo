...
if __name__ == "__main__":
    # === EDIT THESE PATHS ===
    MODEL_PATH = r"R:/Mine/AllOfMe/T.A. Penelitian/ML_Model/Experiments/UpdatedExperiments/Model-DataCoevolution/CoevolutionResult/best_model.pkl"
    REAL_DATA_PATH = r"R:\Mine\AllOfMe\T.A. Penelitian\ML_Model\RealData\Dataset_Train_70.csv"   # your 70%/30% split
